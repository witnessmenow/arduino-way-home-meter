...
const unsigned long delayBetweenChecks = 5000; //mean time between api requests
unsigned long whenDueToCheck = 0;

const unsigned long delayBetweenGoogleMapChecks = 60000; //mean time between api requests
...
void handleGoogleMapsUpdate() {
  Serial.printf("4Available RAM: %d\n", ESP.getFreeHeap());
  getTravelTime(lastRecievedCoOrds);
  Serial.printf("5Available RAM: %d\n", ESP.getFreeHeap());
